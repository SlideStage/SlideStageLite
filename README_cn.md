<p align="center">
  <a href="https://slidestage.dev">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/SlideStage/SlideStageLite/main/packages/brand/assets/png/slidestage-logo-horizontal-on-dark@2x.png">
      <img src="https://raw.githubusercontent.com/SlideStage/SlideStageLite/main/packages/brand/assets/png/slidestage-logo-horizontal@2x.png" alt="SlideStage Lite" width="520">
    </picture>
  </a>
</p>
...
<table>
  <tr>
    <td align="center" valign="top" width="33%">
      ...
      <sub>在任意浏览器中打开、播放、转换 <code>.stage</code> 文件。零后端，零账号。</sub>
    </td>
    <td align="center" valign="top" width="33%">
      ...
      <sub>多用户 <code>.stage</code> 协作平台，含笔记、批注、管理员邀请、Docker 部署。</sub>
    </td>
    <td align="center" valign="top" width="33%">
      ...
      <sub>把任何 HTML deck (reveal / impress / html-ppt / huashu / 纯 HTML) 打包成可移植的 <code>.stage</code>。</sub>
    </td>
  </tr>
</table>
...
- [`@slidestage/brand`](https://github.com/SlideStage/SlideStageLite/tree/main/packages/brand) — 全产品共享的 SVG / PNG 品牌资产、favicon、social card 与设计 token。 · [![npm](https://img.shields.io/npm/v/@slidestage/brand.svg?style=flat-square&label=npm)](https://www.npmjs.com/package/@slidestage/brand)
- [`@slidestage/spec`](https://github.com/SlideStage/SlideStageLite/tree/main/packages/spec) — `.stage` 容器格式的 TypeScript 类型与运行时校验器。 · [![npm](https://img.shields.io/npm/v/@slidestage/spec.svg?style=flat-square&label=npm)](https://www.npmjs.com/package/@slidestage/spec)
<!-- END: slidestage-ecosystem -->

> 通过 `pnpm render:ecosystem` 重新生成该 block。产品注册表在
> `packages/brand/src/products.data.mjs`。
